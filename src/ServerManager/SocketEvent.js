...
class SocketEvent {
    ...
    */
    ...
    /**
     * 
     * @param {string} eventName - This is the name of the event the server will be opening a socket for. This is also the event name you will subscribe and emit.
     * @param {onEventCallback} - The callback function that will be invoked when a message is received matching the eventName
     */
